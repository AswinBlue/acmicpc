...
def dfs(cnt,scoreDic, P):
    if P > 0:
        print(cnt, P, scoreDic, ansDic)
        if cnt != 6:
            print(stringList[cnt])
    else:
        return
    ...
    print(cnt, 'a win', P*float(stringList[cnt][2]))
    ...
    print(cnt, 'tie', P*float(stringList[cnt][2]))
    ...
    print(cnt, 'a lose', P*float(stringList[cnt][4]))
